...
function HomePage() {
  return (
    <div className="flex flex-col items-center justify-center h-screen text-white px-2">
        ...
        <p className="mb-20">The ObiOne ChatGPT experimental replica.</p>
        
        <div className="flex space-x-2 text-center">
            <div>
                <div className="flex flex-col items-center justify-center mb-5">
                <SunIcon className="h-8 w-8 fill-darkdarkblue "/>
                    <h2>Examples</h2>
                </div>
            ...
            <div>
                <div className="flex flex-col items-center justify-center mb-5">
                <BoltIcon className="h-8 w-8 fill-darkdarkblue "/>
                    <h2>Capabilities</h2>
                </div>

                <div className="space-y-2">
                    <p className="infoText">"Change between different ChatGPT models"</p>
                    <p className="infoText">"Messages are stored for you"</p>
            ...
            <div>
                <div className="flex flex-col items-center justify-center mb-5">
                <ExclamationTriangleIcon className="h-8 w-8 fill-darkdarkblue "/>
                    <h2>Limitations</h2>
                </div>
